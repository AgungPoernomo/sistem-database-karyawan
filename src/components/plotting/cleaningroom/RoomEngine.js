        ...
        statsContainer.innerHTML = `
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center bg-cyan-50/80 dark:bg-cyan-900/30 border border-cyan-200 dark:border-cyan-500/40 px-4 py-3.5 rounded-2xl shadow-inner mt-2">
                    <span class="text-cyan-800 dark:text-cyan-300 font-black">TOTAL</span> <span class="text-cyan-600 dark:text-white font-black text-xl drop-shadow-[0_0_5px_rgba(14,165,233,0.5)]">${dataToRender.length}</span>
                </div>
            </div>
