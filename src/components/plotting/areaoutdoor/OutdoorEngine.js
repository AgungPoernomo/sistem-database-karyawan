    ...
    tableContainer.innerHTML = `
        <table class="w-full text-left whitespace-nowrap text-[10px] font-mono tracking-widest">
            <thead class="sticky top-0 bg-white/90 dark:bg-slate-950/90 backdrop-blur-xl z-10 border-b border-slate-200 dark:border-slate-800 text-slate-500 dark:text-emerald-500/80 shadow-sm">
                <tr><th class="p-4 font-bold text-center pl-6">Foto</th><th class="p-4 font-bold">PIC (Otorisator)</th><th class="p-4 font-bold text-center">Line / Plant</th><th class="p-4 font-bold text-center">Area Name</th><th class="p-4 font-bold text-center">Zone Type</th><th class="p-4 font-bold pr-6">Purpose</th></tr>
            </thead>
