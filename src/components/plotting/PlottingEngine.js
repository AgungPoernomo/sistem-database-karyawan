// src/components/plotting/PlottingEngine.js
...
export function updatePlottingStats(lineData, areaData) {
    // KAKULASI
    let pria = 0, wanita = 0; 
    ...
    // RENDER MINI STATS BAWAH
    const miniStatsContainer = document.getElementById('miniStatsContainer');
...
export function renderPlottingTable(containerId, data) {
    ...
    let tableHTML = `
        <table class="w-full text-left whitespace-nowrap text-[10px] font-mono tracking-widest">
            <thead class="sticky top-0 bg-white/90 dark:bg-slate-950/90 backdrop-blur-xl z-10 border-b border-slate-200 dark:border-slate-800 text-slate-500 dark:text-emerald-500/80 shadow-sm">
                <tr>
                    <th class="p-4 font-bold text-center pl-6">Visual</th>
                    <th class="p-4 font-bold">ID Node</th>
                    <th class="p-4 font-bold">Identitas Asli</th>
                    <th class="p-4 font-bold text-center">Grup</th>
                    <th class="p-4 font-bold text-center">Zonasi</th>
                    <th class="p-4 font-bold pr-6">Kode Spasial</th>
                </tr>
            </thead>
